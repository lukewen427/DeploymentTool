...
/**
 * This interface allows blocks to create APIBroker objects which allow limited
 * access to the server API
 * @author hugo
 */
public interface APIBrokerFactory extends Remote {
    /** Create a new API broker as another user */
    public APIBroker createApi(User user, String invocationId) throws RemoteException, ConnexienceException;
    
    /** Create a new APIBroker */
    public APIBroker createApi(Ticket ticket, String invocationId) throws RemoteException, ConnexienceException;
    
    /** Create a new APIBroker with provenance data */
