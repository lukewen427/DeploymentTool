...
/**
 * This class listens to a library download to get progress notifications.
 * @author nhgh
 */
public interface LibraryDownloadListener {
    /** Download completed ok */
    public void downloadComplete(CloudWorkflowServiceLibraryItem library);

    /** A download had an error */
