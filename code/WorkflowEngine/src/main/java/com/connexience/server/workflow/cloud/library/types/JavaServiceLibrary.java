...
import org.w3c.dom.*;
/**
 * This library wrapper provides java service specific library functionality
 * @author nhgh
 */
public class JavaServiceLibrary extends LibraryWrapper {

    public JavaServiceLibrary() {
    }


    public JavaServiceLibrary(CloudWorkflowServiceLibraryItem libraryItem) {
        super(libraryItem);
    }
