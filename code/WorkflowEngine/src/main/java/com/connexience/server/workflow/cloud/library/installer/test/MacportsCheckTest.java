 ...
 * @author hugo
 */
public class MacportsCheckTest {
    public static void main(String[] args){
        try {
            MacportsPackageManager mgr = new MacportsPackageManager();
            System.out.println("Octave: " + mgr.isInstalled("octave", new LibraryPreparationReport()));
            System.out.println("R: " + mgr.isInstalled("R", new LibraryPreparationReport()));
        } catch (Exception e){
            e.printStackTrace();
        }
    }
