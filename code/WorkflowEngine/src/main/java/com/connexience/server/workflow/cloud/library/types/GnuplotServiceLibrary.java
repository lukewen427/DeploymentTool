...
/**
 * This class provides server side support for gnu plot services.
 * @author nhgh
 */
public class GnuplotServiceLibrary extends LibraryWrapper {

    public GnuplotServiceLibrary() {
    }


    public GnuplotServiceLibrary(CloudWorkflowServiceLibraryItem libraryItem) {
        super(libraryItem);
    }
