...
/**
 * This class tests an exact value of a numerical item
 * @author hugo
 */
public class ExactNumericalMetadataQueryItem extends MetadataQueryItem {
    /**
     * Class version UID.
     * 
    ...
    public ExactNumericalMetadataQueryItem() {
        setLabel("Exact Value");
    }
    
    @Override
    public String createQuery() {
        return " objectid in (select objectid from metadata where (" + createQueryRoot() + " and longvalue=:" + createNamedParameterTag() + ") ";
    }
